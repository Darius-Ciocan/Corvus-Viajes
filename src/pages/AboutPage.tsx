export default function AboutPage() {
  return (
    <section className="page-shell grid gap-8 py-12 lg:grid-cols-[0.9fr_1.1fr]">
      <div>
        <p className="text-sm font-black uppercase text-emerald-800">Sobre el proyecto</p>
        <h1 className="text-4xl font-black text-stone-950">Una agencia pensada como microapp</h1>
      </div>
